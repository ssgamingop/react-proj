      ...
      <div className="flex flex-col gap-6 max-w-[1600px] mx-auto h-full animate-in fade-in duration-500">
        <div className="flex justify-between items-end">
          ...
          <div className="flex gap-3">
             <button className="bg-white/80 dark:bg-[#131722]/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800/60 rounded-xl px-4 py-2 text-sm font-bold flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors text-slate-700 dark:text-slate-300">
               <Settings2 className="w-4 h-4" /> Columns
             </button>
             <button className="bg-white/80 dark:bg-[#131722]/80 backdrop-blur-xl border border-slate-200 dark:border-slate-800/60 rounded-xl px-4 py-2 text-sm font-bold flex items-center gap-2 hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors text-slate-700 dark:text-slate-300">
               <Filter className="w-4 h-4" /> Filters
             </button>
             <button className="bg-primary hover:bg-primary-dark text-white rounded-xl px-4 py-2 text-sm font-bold flex items-center gap-2 transition-colors shadow-[0_0_15px_rgba(99,102,241,0.3)]">
